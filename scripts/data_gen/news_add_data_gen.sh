...
declare -a t_noise_dists=("normal") # useless
declare -a me_dists=("normal")
declare -a me_stds=("0.15" "0.2")
    ...
    do
        ...
        do
            ...
            do
                ...
                python_command="python data/news_add_generate_data.py --save_dir dataset/news_add/gene_data \
                                                  --me_std $me_std \
                                                  --me_dist $me_dist \
